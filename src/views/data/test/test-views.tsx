...
const TestView = ({ base_url = "", akses = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage={"Data"} subTitle="Test" />
          ...
          <div className="card" id="tasksList">
            <div className="card-header border-0">
              <div className="d-flex align-items-center">
                <h5 className="card-title mb-0 flex-grow-1">Test List</h5>
            ...
            <GridSearch
              ...
              value={["id", "judul", "category_name", "remarks"]}
              limit={25}
            />
          </div>
        </div>
