...
import ListInstroductionTableViews from "./list-table-introduction";

const ListIntroductionTestViews = ({ base_url = "/" }) => {
  ...
  const handleDelete = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (dataChecked.length > 0) {
      Message.question("Apa anda yakin menghapus data ini?", () => {
        ...
        const req = fetch(
          process.env.API_BASE_URL + base_url+"/delete-all-introduction",
          {
            method: "POST",
            headers: {
      ...
      <div className="card">
        <div className="card-header border-0">
          <div className="d-flex align-items-center">
            <h5 className="card-title mb-0 flex-grow-1">Test Introduction List</h5>
            <div className="flex-shrink-0">
              <Link
                href={base_url + "/add-introduction?test_sub="+id}
...
export default ListIntroductionTestViews;
