...
const AppCandidateView = ({ base_url = "", akses = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage={"Data"} subTitle="Candidate" />
            ...
            <GridSearch
              ...
              columns={[
                ...
                },
                {
                  ...
                  name: "NIK",
                  formatter(cell: any, row: any, column: any) {
                    const dataJob = String(row.cells[4].data).split("/");
...
export default AppCandidateView;
