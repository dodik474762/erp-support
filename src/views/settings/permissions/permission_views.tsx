...
const SettingPermissionViews = ({ base_url = "", akses = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage={"Settings"} subTitle="Permissions" />
        ...
        <div className="col-lg-12">
          <div className="card" id="tasksList">
            ...
            <GridSearch
              ...
              value={["id", "menu_name", "username", "action"]}
              limit={25}
            />
          </div>
        </div>
...
export default SettingPermissionViews;
