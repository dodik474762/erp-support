...
const ApprovalVendorDetailViews = ({ base_url = "" }) => {
  ...
  return (
    <>
      <PageTitle
        titlePage="Approval Request Vendor"
        subTitle={"Approval Request Vendor Detail ID :" + id}
      />
              ...
              <div className="card-body">
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="form-control"
                    id="product-title-input"
                    placeholder="Enter vendor erp code"
...
export default ApprovalVendorDetailViews;
