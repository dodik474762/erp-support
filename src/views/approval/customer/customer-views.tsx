...
const ApprovalCustomerViews = ({ base_url = "", akses = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage={"Approval"} subTitle="Request Customer" />
        ...
        <div className="col-lg-12">
          <div className="card" id="tasksList">
            ...
            <GridSearch
              ...
              value={["id", "customer_name", "remarks", "status"]}
              limit={25}
            />
          </div>
        </div>
...
export default ApprovalCustomerViews;
