...
const MasterJobTitleViews = ({ base_url = "", akses = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage={"Master"} subTitle="Job Title" />
          ...
          <div className="card" id="tasksList">
            <div className="card-header border-0">
              <div className="d-flex align-items-center">
                <h5 className="card-title mb-0 flex-grow-1">Job Title List</h5>
            ...
            <GridSearch
              ...
              value={["id", "job_title_code", "job_name"]}
              limit={25}
            />
          </div>
        </div>
...
export default MasterJobTitleViews;
