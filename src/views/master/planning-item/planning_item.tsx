...
const MasterPlanningItemViews = ({ base_url = "", akses = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage={"Master"} subTitle="Planning Item" />
          ...
          <div className="card" id="tasksList">
            <div className="card-header border-0">
              <div className="d-flex align-items-center">
                <h5 className="card-title mb-0 flex-grow-1">Planning Item List</h5>
...
export default MasterPlanningItemViews;
