...
const FormPlanningItemDetailViews = ({ base_url = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage="Detail" subTitle="Planning Item" />
          ...
          <div className="col-lg-8">
            <div className="card">
              <div className="card-header">
                <h5 className="card-title mb-0">Planning Item</h5>
              </div>
...
export default FormPlanningItemDetailViews;
