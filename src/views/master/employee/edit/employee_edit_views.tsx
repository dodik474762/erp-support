...
const EmployeeEditViews = ({ base_url = "" }) => {
  ...
  const fetchDataJobTitle = async () => {
    ...
    const req = await fetch(
      process.env.API_BASE_URL + "/master/job_title/getAll",
      {
        headers: {
  ...
  return (
    <>
      <PageTitle titlePage="Master" subTitle={"Employee Edit ID : " + id} />
...
export default EmployeeEditViews;
