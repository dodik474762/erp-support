...
const FormGroupTypeDetailViews = ({ base_url = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage="Detail" subTitle="Group Type" />
          ...
          <div className="col-lg-8">
            <div className="card">
              <div className="card-header">
                <h5 className="card-title mb-0">Group Type</h5>
              </div>
...
export default FormGroupTypeDetailViews;
