...
const FormVolumeTypeDetailViews = ({ base_url = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage="Detail" subTitle="Volume Type" />
          ...
          <div className="col-lg-8">
            <div className="card">
              <div className="card-header">
                <h5 className="card-title mb-0">Volume Type</h5>
              </div>
...
export default FormVolumeTypeDetailViews;
