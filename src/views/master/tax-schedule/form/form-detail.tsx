...
const FormTaxScheduleDetailViews = ({ base_url = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage="Detail" subTitle="Tax Schedule" />
          ...
          <div className="col-lg-8">
            <div className="card">
              <div className="card-header">
                <h5 className="card-title mb-0">Tax Schedule</h5>
              </div>
...
export default FormTaxScheduleDetailViews;
