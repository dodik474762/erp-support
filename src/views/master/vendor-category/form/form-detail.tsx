...
const FormVendorCategoryDetailViews = ({ base_url = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage="Detail" subTitle="Vendor Category" />
          ...
          <div className="col-lg-8">
            <div className="card">
              <div className="card-header">
                <h5 className="card-title mb-0">Vendor Category</h5>
              </div>
...
export default FormVendorCategoryDetailViews;
