...
const FormSubsidiaryDetailViews = ({ base_url = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage="Detail" subTitle="Subsidiary" />
          ...
          <div className="col-lg-8">
            <div className="card">
              <div className="card-header">
                <h5 className="card-title mb-0">Subsidiary</h5>
              </div>
...
export default FormSubsidiaryDetailViews;
