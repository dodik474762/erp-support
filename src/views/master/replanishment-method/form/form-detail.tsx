...
const FormReplanishmentMethodDetailViews = ({ base_url = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage="Detail" subTitle="Replanishment Method" />
          ...
          <div className="col-lg-8">
            <div className="card">
              <div className="card-header">
                <h5 className="card-title mb-0">Replanishment Method</h5>
              </div>
...
export default FormReplanishmentMethodDetailViews;
