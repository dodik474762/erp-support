...
const JobTestView = ({ base_url = "", akses = "" }) => {
  ...
  return (
    <>
      <PageTitle titlePage={"Data"} subTitle="Job Vacancy Test" />
          ...
          <div className="card" id="tasksList">
            <div className="card-header border-0">
              <div className="d-flex align-items-center">
                <h5 className="card-title mb-0 flex-grow-1">Job Test List</h5>
            ...
            <GridSearch
              ...
              value={["id", "job", "nama_job", "remarks", "start_date", "end_date"]}
              limit={40}
            />
          </div>
        </div>
