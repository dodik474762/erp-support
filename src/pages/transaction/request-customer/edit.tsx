...
import FormRequestCustomerViews from "@/views/transaction/request-customer/form/form-request-customer";
import { useSession } from "next-auth/react";
import { useEffect, useState } from "react";

const RequestCustomerEditPage = () => {
  ...
  return (
    <>
      {akses.includes("update") ? (
        ...
        <FormRequestCustomerViews base_url={base_url}/>
        </>
      ) : (
        <>
...
export default RequestCustomerEditPage;
