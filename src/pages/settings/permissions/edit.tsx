...
import PermissionEditViews from "@/views/settings/permissions/edit/permission_edit_views";
import { useSession } from "next-auth/react";
import { useEffect, useState } from "react";

const SettingEditPermissionPage = () => {
    ...
    return (
      <>
        {akses.includes("update") ? (
          ...
          <PermissionEditViews base_url={base_url} />
          </>
        ) : (
          <>
...
export default SettingEditPermissionPage;