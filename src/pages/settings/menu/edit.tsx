...
import MenuEditViews from "@/views/settings/menu/edit/menu_edit_views";
import { useSession } from "next-auth/react";
import { useEffect, useState } from "react";

const SettingMenuEditPage = () => {
    ...
    return (
      <>
        {akses.includes("update") ? (
          ...
          <MenuEditViews base_url={base_url} />
          </>
        ) : (
          <>
...
export default SettingMenuEditPage;