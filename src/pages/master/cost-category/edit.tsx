...
import FormCostCategoryViews from "@/views/master/cost-category/form/form-cost-category";
import { useSession } from "next-auth/react";
import { useEffect, useState } from "react";

const CostCategoryEditPage = () => {
  ...
  return (
    <>
      {akses.includes("update") ? (
        ...
        <FormCostCategoryViews base_url={base_url}/>
        </>
      ) : (
        <>
...
export default CostCategoryEditPage;
