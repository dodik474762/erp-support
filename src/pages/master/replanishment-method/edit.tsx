...
import FormReplanishmentMethodViews from "@/views/master/replanishment-method/form/form-replanishment";
import { useSession } from "next-auth/react";
import { useEffect, useState } from "react";

const ReplanishmentMethodEditPage = () => {
  ...
  return (
    <>
      {akses.includes("update") ? (
        ...
        <FormReplanishmentMethodViews base_url={base_url}/>
        </>
      ) : (
        <>
...
export default ReplanishmentMethodEditPage;
