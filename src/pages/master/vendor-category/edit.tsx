...
import FormVendorCategoryViews from "@/views/master/vendor-category/form/form-vendor-category";
import { useSession } from "next-auth/react";
import { useEffect, useState } from "react";

const VendorCategoryEditPage = () => {
  ...
  return (
    <>
      {akses.includes("update") ? (
        ...
        <FormVendorCategoryViews base_url={base_url}/>
        </>
      ) : (
        <>
...
export default VendorCategoryEditPage;
