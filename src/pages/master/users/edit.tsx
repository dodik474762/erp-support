...
import UsersEditViews from "@/views/master/users/edit/users_edit_views"
import { useSession } from "next-auth/react";
import { useEffect, useState } from "react";


const MasterUserEditPage = () => {
    ...
    return (
      <>
        {akses.includes("update") ? (
          ...
          <UsersEditViews base_url={base_url} />
          </>
        ) : (
          <>
...
export default MasterUserEditPage;